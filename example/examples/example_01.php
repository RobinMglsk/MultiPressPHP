...
if (isset($_GET['exec']) && $_GET['exec'] == 1) {
	...
	$autofill->setPdfLink(10);
	$autofill->setPages(2);
	$autofill->addProductionLine('Printen', 2, $_GET['paper'], '4/4');
	var_dump($autofill->toArray());
